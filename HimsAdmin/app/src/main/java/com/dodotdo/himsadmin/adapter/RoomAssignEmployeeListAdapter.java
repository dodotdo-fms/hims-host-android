 ...
 */
public class RoomAssignEmployeeListAdapter extends RecyclerView.Adapter<MyRecyclerView.ViewHolder> {
    ...
    List<Employee> datas;
    ViewModels data;
    public interface OnRoomAssignEmployeeListAdpterListener{
        void goAssignRoom(Employee employee);
    }
    OnRoomAssignEmployeeListAdpterListener listener;
    public RoomAssignEmployeeListAdapter(Context context, List<Employee> datas) {
        mContext = context;
        this.datas = datas;
        setDatas();
    }

    public void setListener(OnRoomAssignEmployeeListAdpterListener listener) {
    ...
    public void setDatas(){
        ...
        for(String position : employeeMap.keySet()){
            if(position.equals("housekeeper")||position.equals("self-evaluator")) {
